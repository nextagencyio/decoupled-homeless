...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact New Horizons Shelter. We\'d love to hear from you about shelter services, volunteering, or making a donation.',
  keywords: ['Contact New Horizons Shelter', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about shelter services, volunteering, or making a donation? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@newhorizonsshelter.org</p>
                    <p className="text-gray-600">support@newhorizonsshelter.org</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 123-4516</p>
